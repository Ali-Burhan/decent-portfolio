  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute top-0 right-0 w-[600px] h-[600px] rounded-full bg-accent/10 blur-[120px] opacity-50" />
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] rounded-full bg-accent/10 blur-[100px] opacity-40" />
      </div>
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 sm:px-8 lg:px-12 py-20">
        <div className="text-center">
          ...
          >
            ...
            <span className="px-4 py-1.5 bg-foreground/5 border border-foreground/10 rounded-full text-foreground/60 text-sm font-medium">
          ...
          >
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight leading-tight">
              <span className="block text-foreground/80 mb-2">{t("hero.greetingPrefix")}</span>
          ...
          >
            <a
              ...
              className="p-3 bg-foreground/5 border border-foreground/10 rounded-lg text-foreground/60 hover:text-accent hover:border-accent/50 transition-all"
              aria-label="GitHub"
            >
      ...
      >
        ...
        >
          <span className="text-xs font-mono text-foreground/40 uppercase tracking-wider">{t("hero.scroll")}</span>
